...
namespace CashCare.Migrations
{
    ...
    [Migration("20240528125958_AddSavingModule")]
    partial class AddSavingModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CashCare.Models.DailyExpense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CashCare.Models.Wallet.Saving", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MonthlySavingAmount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CashCare.Models.DailyExpense", b =>
                {
                    b.HasOne("CashCare.Models.AppUser", "AppUser")
                        .WithMany("ExpensesDaily")
            ...
            modelBuilder.Entity("CashCare.Models.Wallet.Saving", b =>
                {
                    b.HasOne("CashCare.Models.Wallet.Wallet", "Wallet")
                        .WithOne("Saving")
                        .HasForeignKey("CashCare.Models.Wallet.Saving", "WalletId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
